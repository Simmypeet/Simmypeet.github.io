...
Hi, this is my follow up post on the [building query-based incremental compiler](https://dev.to/simmypeet/building-a-query-based-incremental-compilation-engine-in-rust-nj6). This has been my rabbit hole for past few months.
...
I've also packaged this into a separate library called [QBICE](https://github.com/Simmypeet/qbice) if anyone is interested 😉.
